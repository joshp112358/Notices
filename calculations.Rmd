...
plot9 <- ggplot(df, aes(x=amscitperyear))+
  ...
  geom_vline(xintercept = mean(filter(df, (lettergroup == "A Only"|lettergroup == "A and B"))$amscitperyear, na.rm = TRUE), linetype="solid", color = "red", size=1.5) +
  geom_vline(xintercept = mean(filter(df, (lettergroup == "B and C"|lettergroup == "B Only"|lettergroup == "A and B"))$amscitperyear, na.rm = TRUE), linetype="solid", color = "blue", size=1.5) +
  geom_vline(xintercept = mean(filter(df, (lettergroup == "C Only"|lettergroup == "B and C"))$amscitperyear, na.rm = TRUE), linetype="solid", color = "green", size=1.5) +
...
plot9 <- ggplot(df, aes(x=amscitperyearpower))+
  ...
  geom_histogram(data=filter(df, (lettergroup == "B and C"|lettergroup == "B Only"|lettergroup == "A and B")),fill = "blue", alpha = 0.2, binwidth = 5) +
  geom_histogram(data=filter(df, (lettergroup == "C Only"|lettergroup == "B and C")),fill = "green", alpha = 0.2, binwidth = 5) +
  geom_vline(xintercept = mean(filter(df, (lettergroup == "A Only"|lettergroup == "A and B"))$amscitperyearpower, na.rm = TRUE), linetype="solid", color = "red", size=1.5) +
  geom_vline(xintercept = mean(filter(df, (lettergroup == "B and C"|lettergroup == "B Only"|lettergroup == "A and B"))$amscitperyearpower, na.rm = TRUE), linetype="solid", color = "blue", size=1.5) +
  geom_vline(xintercept = mean(filter(df, (lettergroup == "C Only"|lettergroup == "B and C"))$amscitperyearpower, na.rm = TRUE), linetype="solid", color = "green", size=1.5) +
...
```{r, echo = FALSE}
mean(filter(df, (lettergroup == "A Only"|lettergroup == "A and B")&field=="math"&institution=="domesticr1")$citperyear, na.rm = TRUE)
mean(filter(df, (lettergroup == "B and C"|lettergroup == "B Only"|lettergroup == "A and B")&field=="math"&institution=="domesticr1")$citperyear, na.rm = TRUE)
mean(filter(df, (lettergroup == "C Only"|lettergroup == "B and C")&field=="math"&institution=="domesticr1")$citperyear, na.rm = TRUE)
median(filter(df, (lettergroup == "A Only"|lettergroup == "A and B")&field=="math"&institution=="domesticr1")$citperyear, na.rm = TRUE)
median(filter(df, (lettergroup == "B and C"|lettergroup == "B Only"|lettergroup == "A and B")&field=="math"&institution=="domesticr1")$citperyear, na.rm = TRUE)
median(filter(df, (lettergroup == "C Only"|lettergroup == "B and C")&field=="math"&institution=="domesticr1")$citperyear, na.rm = TRUE)
```
```{r}
...
set.seed(0)
pop<- filter(df, (institution=="domesticr1"))

n_a <- length(na.omit(filter(df, (lettergroup == "A Only"|lettergroup == "A and B")&institution=="domesticr1")$citperyear))
n_b <- length(na.omit(filter(df, (lettergroup == "B and C"|lettergroup == "B Only"|lettergroup == "A and B")&institution=="domesticr1")$citperyear))
n_c <- length(na.omit(filter(df, (lettergroup == "C Only"|lettergroup == "B and C")&institution=="domesticr1")$citperyear))
...
```{r, echo=FALSE}
sum(dist1 < val1)/length(dist)
sum(dist2 < val2)/length(dist)
sum(dist3 < val3)/length(dist)
```
