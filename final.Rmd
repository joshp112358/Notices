...
```{r}
table(filter(df, (lettergroup == "B Only"|lettergroup == "A and B")&(role=="professor")
                  &(field=="math")
                  &(institution=="domesticr1"))$fellows)
```
94 signers of letter B were fellows of the AMS, 58 of whom were math professors at domesticr1 universities. 
```{r}
